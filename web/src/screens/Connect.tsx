  ...
  },
  {
    ...
    guide: {
      steps: [
        ...
        '내보내기 생성 → 완료 메일에서 .mbox 다운로드 → 여기에 업로드',
        'Outlook: 저장할 메일 선택 → 바탕화면으로 드래그(또는 "다른 이름으로 저장")하면 .eml 생성',
        '받은 .mbox 또는 .eml 파일을 여기에 업로드',
      ],
      caution: '.mbox(메일함 전체)와 .eml(개별 메일, 여러 개 가능)을 지원합니다. 버전·플랜에 따라 메뉴 위치가 다를 수 있습니다.',
    },
  },
  {
    key: 'jira',
