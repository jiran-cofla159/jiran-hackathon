...
const SYSTEM_3A = `너는 신입 후임자(이도현 사원)의 첫 한 달 온보딩 로드맵을 설계한다. 오늘: 2026-07-06. 전임자 퇴사일: 2026-07-31.
설계 원칙:
- week 0(즉시)에는 데드라인이 이미 지났거나 상대가 기다리는 일.
- week는 오늘(2026-07-06)부터 센다: week 1 = ~7/12, week 2 = 7/13~7/26 부근(3주차 개념 포함), week 4 = 그 이후 한 달 내.
...
const SYSTEM_3B = `너는 인수인계 문서의 구멍을 찾아 전임자에게 인터뷰 질문을 만드는 역할이다. 오늘: 2026-07-06. 전임자: 김하늘 (퇴사일 2026-07-31). 후임자: 이도현 사원(신입).
구멍의 유형:
...
export async function runStage3a(map: WorkMap): Promise<RoadmapItem[]> {
